...
public class Base implements Config {
	...
	public void startDriverold() {
		...
		// Arrays.asList("--disable-popup-blocking",
		// "--always-authorize-plugins"));
		System.setProperty("webdriver.gecko.driver","D:\\Software\\geckodriver-v0.9.0-win64\\geckodriver.exe");
	...
	public void startDriver() {
		//ChromeDriverManager.getInstance().arch64().proxy("172.18.65.50:8080").setup();
		ChromeDriverManager.getInstance().setup();
		//DesiredCapabilities caps = DesiredCapabilities.chrome();
		//caps.setCapability("applicationCacheEnabled", false);
		//System.setProperty("webdriver.chrome.driver",
	...
	public static WebElement waitForElementToAppear(WebDriver driver, WebElement locator) {
